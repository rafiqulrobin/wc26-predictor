export default async function handler(req, res) {
  ...
  const desc = `I predicted ${t1} ${s1}-${s2} ${t2} in the World Cup 2026! Can you beat my score? livewc26.com`;
  const imgUrl = `https://livewc26.com/api/og-image?t1=${encodeURIComponent(t1)}&t2=${encodeURIComponent(t2)}&s1=${s1}&s2=${s2}`;
